  ...
  return (
    <div className="w-full flex flex-col gap-5 lg:gap-0 lg:flex-row justify-between p-5 bg-[#95959533] rounded-3xl">
      ...
      <div className="bg-images hidden lg:block">
        <Image className="bottom-[400px] right-[100px] absolute z-[-1] rounded-3xl rotate-45 w-[150px] h-[150px]" width={400} height={400} src="/gradient.png" alt=""/>
        ...
        <Image className="bottom-[-165px] right-[300px] absolute z-[-1] rounded-3xl rotate-45 w-[300px] h-[300px]" width={400} height={400} src="/gradient.png" alt=""/>
      </div>
    </div>
  );
}
